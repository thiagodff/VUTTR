...
var ListTools = /** @class */ (function () {
    function ListTools() {
    }
    ListTools.prototype.run = function (_a) {
        var userId = _a.userId;
        return __awaiter(this, void 0, void 0, function () {
            var tools, formatTools;
            var _this = this;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(tools.map(function (tool) { return __awaiter(_this, void 0, void 0, function () {
                                var id, title, link, description, user, tags, formatTags;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            tags = _a.sent();
                                            formatTags = tags.map(function (tag) { return tag.name; });
                                            return [2 /*return*/, {
                                                    id: id,
                                                    title: title,
                                                    link: link,
...
exports.default = new ListTools();
//# sourceMappingURL=ListToolsService.js.map